...
import { detail as query, downloadDetailExcel } from '../backupbusinessvolume/service'
import { initialCreateTime, APIV3, pageModel } from '../../utils'

export default modelExtend(pageModel, {
  namespace: 'backupbusinessvolumedetail',
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/backupbusinessvolumedetail') {
          dispatch({
            type: 'query',
